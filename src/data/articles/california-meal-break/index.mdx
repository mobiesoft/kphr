...
articleSection: California Labor Law, Hiring & Compliance
keywords:
  - California Meal Break Law
  - california rest break requirements
  - meal and rest break penalties
videoDuration: PT4M11S
videoRegionsAllowed:
  - US
  - CA
faqs:
  - question: Are California meal breaks required to be unpaid?
    answer: Yes. A compliant meal period must be at least 30 minutes, unpaid, and
      duty-free. If an employee is required to remain on duty, the meal period
      must be paid.
  - question: Can employees waive their meal breaks in California?
    answer: A first meal period may be waived only if the employee works no more
      than six hours and the waiver is voluntary. Second meal periods may be
      waived only under limited conditions when total hours do not exceed 12 and
      the first meal period was taken.
  - question: How long must employers keep meal and rest break records?
    answer: Employers should retain time and payroll records for at least four years
      in California, as meal and rest break claims are often raised in wage
