...
SB 1162 aims to reduce wage gaps based on gender, race, or other protected characteristics. Key requirements include:
### Pay Scale Disclosure in Job Postings (15+ Employees)
...
### Pay Scale Disclosure to Current Employees (All Employers)
